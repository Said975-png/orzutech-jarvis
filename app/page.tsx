...
export default function Home() {
  ...
  const products: Product[] = [
    ...
    { id: 5, name: "Умны�� часы", price: 34900, description: "Современные смарт-часы с мониторингом здоровья и спортивными функциями" },
              ...
              <div className="relative overflow-hidden max-w-lg h-12">
                <div className="absolute inset-0 flex items-center">
                  <div className="flex animate-scroll space-x-8 text-sm text-black font-medium">
                    ...
                    <span className="whitespace-nowrap">��олная гарантия на все товары</span>
