...
export default function Home() {
  ...
  const products: Product[] = [
    ...
    { id: 5, name: "Умн��е часы", price: 34900, description: "Современные смарт-часы с мониторингом здоровья и спортивными функциями" },
        ...
        <div className="border-t border-gray-200 p-8 lg:p-16">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-600 uppercase tracking-wide text-sm font-medium">Тов��ро��</div>
            </div>
            <div>
            ...
            <div className="relative">
              <div className="flex animate-scroll space-x-6">
                ...
                <div className="flex-shrink-0 w-80 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 rounded-t-lg overflow-hidden p-6 flex flex-col flex-grow">
                    <img
