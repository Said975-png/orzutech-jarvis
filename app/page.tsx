...
export default function Home() {
  ...
  const products: Product[] = [
    ...
    { id: 5, name: "Умные часы", price: 34900, description: "С��временные смарт-часы с мониторингом здоровья и спортивными функциями" },
        ...
        <div className="border-t border-gray-200 p-8 lg:p-16">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-gray-600 uppercase tracking-wide text-sm font-medium">Кач��ство</div>
            </div>
          </div>
        </div>
